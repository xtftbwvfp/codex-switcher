...
- **Xiaomi MiMo Token Plan 兼容**：内置 MiMo-V2.5 Token Plan 新加坡端点 preset，支持 `tp-` key 和 Chat Completions 翻译。
...
- 内置 GLM、GLM Coding Plan、Xiaomi MiMo Token Plan、FreeModel.dev 等 Relay 预设。
...
| Xiaomi MiMo Token Plan | 支持专用 preset、Chat Completions 协议转换、默认 `mimo-v2.5-pro` 模型映射 |
